...
def parse_search_results_page(driver, url: str) -> tuple[list[dict], BeautifulSoup | None]:
    ...
    print(f"[Parse] Extracted {len(results)} articles from {url}")
    return results, soup
...
def scrape_article_content(driver, url: str) -> str:
    ...
    try:
        ...
        try:
            ...
            print(f"[Content] Timeout waiting for <p> tags.")
            return ""
...
def scrape_cnbc_news(query: str, filter_date: str | None = None,
                     headless: bool = True,
