"""
Azure Function for KontanBiodiesel scraper.
...
from scrapers.kontan_biodiesel_scraper import KontanBiodieselScraper
from shared.azure_logging import AzureLoggingManager

SOURCE_NAME = "KontanBiodiesel"
...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    log_manager = AzureLoggingManager(
        function_name="kontan_biodiesel_scraper_function",
...
async def _scrape_data(params: Dict[str, Any], log_manager: AzureLoggingManager) -> Dict[str, Any]:
    ...
    scraper = KontanBiodieselScraper()
