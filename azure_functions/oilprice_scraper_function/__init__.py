...
async def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    """
    logging.info('OilPrice scraper function triggered')
    ...
    try:
        ...
        logging.info(f'Scraping OilPrice articles for keywords: {keywords}, date range: {start_date} to {end_date}')
        ...
        logging.info(f'Successfully scraped {len(articles)} articles from OilPrice')
        ...
        logging.error(f'Error in OilPrice scraper function: {str(e)}', exc_info=True)
