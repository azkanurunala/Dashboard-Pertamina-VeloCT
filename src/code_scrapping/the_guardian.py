...
if __name__ == "__main__":
    ...
    KEYWORDS: dict[str, list[str]] = {
        "RON 92": [
            "pertamax", "RON 95", "RON 97", "Residual FO", "Fuel Oil",
            "Jet Fuel", "Avtur", "Kerosene", "refinery", "refined products",
            "refining", "oil products", "Gasoline", "Heavy Oil", "Diesel",
            "Gasoil", "Naphtha", "LPG", "Biodiesel", "Biogasoline",
