...
async def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    """
    logging.info('Kontan scraper function triggered')
    ...
    try:
        ...
        logging.info(f'Scraping Kontan articles for keywords: {keywords}, date range: {start_date} to {end_date}')
        ...
        logging.info(f'Successfully scraped {len(articles)} articles from Kontan')
        ...
        logging.error(f'Error in Kontan scraper function: {str(e)}', exc_info=True)
