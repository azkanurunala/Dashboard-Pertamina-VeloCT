...
async def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    """
    logging.info('Kompas scraper function triggered')
    ...
    try:
        ...
        logging.info(f'Scraping Kompas articles for keywords: {keywords}, date range: {start_date} to {end_date}')
        ...
        logging.info(f'Successfully scraped {len(articles)} articles from Kompas')
        ...
        logging.error(f'Error in Kompas scraper function: {str(e)}', exc_info=True)
