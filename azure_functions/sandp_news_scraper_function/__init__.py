"""
Azure Function for SAndPNews scraper.
...
from scrapers.sandp_news_scraper import SAndPNewsScraper
from shared.azure_logging import AzureLoggingManager

SOURCE_NAME = "SAndPNews"
...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    log_manager = AzureLoggingManager(
        function_name="sandp_news_scraper_function",
