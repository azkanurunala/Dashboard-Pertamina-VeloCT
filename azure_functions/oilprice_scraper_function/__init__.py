"""
Azure Function for OilPrice news scraping.
HTTP-triggered function that scrapes news articles from OilPrice.com.
"""
...
try:
    ...
    logging.info("✓ Successfully imported scrape_oilprice_news")
except Exception as e:
    logging.error(f"✗ IMPORT ERROR - scrape_oilprice_news: {str(e)}", exc_info=True)
    raise
...
logging.info("✓✓✓ ALL IMPORTS SUCCESSFUL FOR OILPRICE SCRAPER ✓✓✓")
...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    - max_articles: Maximum number of articles to process (optional, default: 30)
    """
    # Initialize comprehensive logging
    correlation_id = req.headers.get('x-correlation-id')
    log_manager = AzureLoggingManager(
        function_name="oilprice_scraper_function",
    ...
    try:
        ...
        result = asyncio.run(_scrape_oilprice_news(params, log_manager))
...
def _parse_request_parameters(req: func.HttpRequest) -> Dict[str, Any]:
    ...
    max_articles_param = req.params.get('max_articles', '30')
...
async def _scrape_oilprice_news(params: Dict[str, Any], log_manager: AzureLoggingManager) -> Dict[str, Any]:
    """Perform OilPrice news scraping operation."""
