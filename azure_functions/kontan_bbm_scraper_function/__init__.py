"""
Azure Function for Kontan BBM scraper.
...
from scrapers.kontan_bbm_scraper import KontanBBMScraper
...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    log_manager = AzureLoggingManager(
        function_name="kontan_bbm_scraper_function",
