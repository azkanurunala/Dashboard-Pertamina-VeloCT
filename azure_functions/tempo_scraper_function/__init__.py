...
async def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    """
    logging.info('Tempo scraper function triggered')
    ...
    try:
        ...
        logging.info(f'Scraping Tempo articles for keywords: {keywords}, date range: {start_date} to {end_date}')
        ...
        logging.info(f'Successfully scraped {len(articles)} articles from Tempo')
        ...
        logging.error(f'Error in Tempo scraper function: {str(e)}', exc_info=True)
