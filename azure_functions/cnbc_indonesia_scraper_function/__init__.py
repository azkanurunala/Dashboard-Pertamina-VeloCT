...
async def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    """
    logging.info('CNBC Indonesia scraper function triggered')
    ...
    try:
        ...
        logging.info(f'Scraping CNBC Indonesia articles for keywords: {keywords}, date range: {start_date} to {end_date}')
        ...
        logging.info(f'Successfully scraped {len(articles)} articles from CNBC Indonesia')
        ...
        logging.error(f'Error in CNBC Indonesia scraper function: {str(e)}', exc_info=True)
