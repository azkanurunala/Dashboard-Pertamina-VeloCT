"""
Azure Function for BloombergTechnoz scraper.
...
from scrapers.bloomberg_technoz_scraper import BloombergTechnozScraper
from shared.azure_logging import AzureLoggingManager

SOURCE_NAME = "BloombergTechnoz"
...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    log_manager = AzureLoggingManager(
        function_name="bloomberg_technoz_scraper_function",
