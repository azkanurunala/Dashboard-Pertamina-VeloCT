...
try:
    ...
    logging.info("✓ Successfully imported CNNNewsScraper")
except Exception as e:
    logging.error(f"✗ IMPORT ERROR - CNNNewsScraper: {str(e)}", exc_info=True)
    raise
...
logging.info("✓✓✓ ALL IMPORTS SUCCESSFUL FOR CNN SCRAPER ✓✓✓")
...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    log_manager = AzureLoggingManager(
        function_name="cnn_scraper_function",
    ...
    try:
        ...
        result = asyncio.run(_scrape_cnn_news(params, log_manager))
...
async def _scrape_cnn_news(params: Dict[str, Any], log_manager: AzureLoggingManager) -> Dict[str, Any]:
    """
