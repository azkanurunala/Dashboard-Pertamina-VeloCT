"""
Azure Function for BisnisIndonesia scraper.
...
from scrapers.bisnis_indonesia_scraper import BisnisIndonesiaNewsScraper
from shared.azure_logging import AzureLoggingManager

SOURCE_NAME = "BisnisIndonesia"
...
async def _scrape_data(params: Dict[str, Any], log_manager: AzureLoggingManager) -> Dict[str, Any]:
    ...
    scraper = BisnisIndonesiaNewsScraper()
