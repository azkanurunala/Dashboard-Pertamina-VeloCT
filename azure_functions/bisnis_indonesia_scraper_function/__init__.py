...
try:
    ...
    logging.info("✓ Successfully imported scrape_bisnis_indonesia_news")
except Exception as e:
    logging.error(f"✗ IMPORT ERROR - scrape_bisnis_indonesia_news: {str(e)}", exc_info=True)
    raise
...
logging.info("✓✓✓ ALL IMPORTS SUCCESSFUL FOR BISNIS INDONESIA SCRAPER ✓✓✓")
...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    log_manager = AzureLoggingManager(
        function_name="bisnis_indonesia_scraper_function",
    ...
    try:
        ...
        result = asyncio.run(_scrape_bisnis_news(params, log_manager))
...
async def _scrape_bisnis_news(params: Dict[str, Any], log_manager: AzureLoggingManager) -> Dict[str, Any]:
    """Perform Bisnis Indonesia news scraping operation."""
