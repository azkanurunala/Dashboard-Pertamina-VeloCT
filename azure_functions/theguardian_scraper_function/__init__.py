...
async def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    """
    logging.info('The Guardian scraper function triggered')
    ...
    try:
        ...
        logging.info(f'Scraping The Guardian articles for keywords: {keywords}, date range: {start_date} to {end_date}')
        ...
        logging.info(f'Successfully scraped {len(articles)} articles from The Guardian')
        ...
        logging.error(f'Error in The Guardian scraper function: {str(e)}', exc_info=True)
